...
namespace Framework.Guide
{
    ...
    public class ExcudeNode : SeqNode
    {
        ...
        {
            return this.type >= (int)GuideExcudeType.CustomBegin && this.type <= (int)GuideExcudeType.CustomEnd;
        }
        //-----------------------------------------------------
        ...
        internal override void CheckPorts()
        {
            ...
            if (!Framework.Guide.Editor.GuideSystemEditor.ExcudeTypes.TryGetValue(type, out nodeAttr))
                return;
