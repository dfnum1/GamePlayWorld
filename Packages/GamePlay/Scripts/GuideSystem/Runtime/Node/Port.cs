...
namespace Framework.Guide
{
    ...
    public class ArgvPort : IPort
    {
        ...
        public int fillValue
        {
            ...
            internal set { m_fillVaue = value; }
        }
        [System.NonSerialized]
        private string m_strFillVaue = null;
        public string fillStrValue
        {
            get { return m_strFillVaue; }
            internal set { m_strFillVaue = value; }
        }
        ...
        {
            m_fillVaue = value;
            m_strFillVaue = strValue;
        }

        public Color ToColor()
        {
            return new Color(
              ((m_fillVaue & 0x00ff0000) >> 16) / 255f,
              ((m_fillVaue & 0x0000ff00) >> 8) / 255f,
              ((m_fillVaue & 0x000000ff)) / 255f,
              ((m_fillVaue & 0xff000000) >> 24) / 255f);
        }
        public Vector2 ToVec2()
        {
            float x = Math.Clamp((m_fillVaue>>16) * 0.01f, -655.35f, 655.35f);
            float y = Math.Clamp(((m_fillVaue & 0xFFFF)) * 0.01f, -655.35f, 655.35f);
