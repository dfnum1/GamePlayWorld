        ...
        */
        ...
        private static bool ValidatePlayCutscene()
        {
            if (!Application.isPlaying)
                return false;
            var runtimeMgr = Editor.DataUtils.GetRuntimeCutsceneManger();
                ...
                if (runtimeMgr != null)
                {
                    ...
                    if(cutscenes!=null)
                    {
                        foreach(var db in cutscenes)
                        {
                            ...
                            {
                                Editor.CutsceneEditor[] editors = EditorWindow.FindObjectsOfType<Editor.CutsceneEditor>();
                                ...
                                Editor.CutsceneEditor newWindow = EditorWindow.GetWindow<Editor.CutsceneEditor>();
