...
namespace Framework.Cutscene.Runtime
{
    ...
    //! ICutsceneObject
    //------------------------------------------------------
    public interface ICutsceneObject : IUserData
    {
    ...
    public static class CutsceneObjectUtil
    {
        ...
        //------------------------------------------------------
        public static bool StopAction(this ICutsceneObject pObj, IUserData pOwner, AnimationClip action, int layer)
        {
            if (pObj == null) return false;
            ms_pParams.Clear();
            ms_pParams.userData = pOwner;
            ms_pParams.unityObject = action;
            ms_pParams.SetInt(layer);
            return pObj.SetParameter(EParamType.eStopAction, ms_pParams);
        }
        //------------------------------------------------------
