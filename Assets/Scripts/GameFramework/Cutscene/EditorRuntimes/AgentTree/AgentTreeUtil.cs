        ...
        internal static void Init(bool bForce = false)
        {
            if (bForce || ms_Attrs == null)
            {
                ...
                foreach (Enum v in Enum.GetValues(typeof(EVariableType)))
                {
                    ...
                    if (fi.IsDefined(typeof(Framework.Base.DisableGUIAttribute)))
                    {
                        continue;
                    }
                    if (fi.IsDefined(typeof(Framework.Base.DisplayAttribute)))
                    {
                        strName = fi.GetCustomAttribute<Framework.Base.DisplayAttribute>().displayName;
                    }
