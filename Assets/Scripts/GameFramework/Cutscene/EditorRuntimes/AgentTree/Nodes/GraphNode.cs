...
namespace Framework.AT.Editor
{
    ...
    {
        public CutsceneAT.Runtime.BaseNode bindNode;
        ...
        public GraphNode(AgentTreeGraphView pAgent, CutsceneAT.Runtime.BaseNode pNode, bool bUpdatePos = true)
        {
            m_pGraphView = pAgent;
            bindNode = pNode;
            var attri = GetAttri();
        ...
        public virtual float GetWidth()
        {
            ...
            foreach (var port in m_vArgvPorts)
            {
                if (port != null && port.attri != null && !string.IsNullOrEmpty(port.attri.name))
                {
                    ...
                    {
                        if (port.GetVariable().GetType() == typeof(VariableString))
                        {
                            w += 70;
                        }
                        else if (port.GetVariable().GetType() == typeof(VariableVec2))
                        {
                            w += 70;
                        }
                        else if (port.GetVariable().GetType() == typeof(VariableVec3))
                        {
                            w += 150;
                        }
                        else if (port.GetVariable().GetType() == typeof(VariableVec4))
                        {
                            w += 210;
                        }
                    }
        ...
        public void Save()
        {
            ...
            if(m_vArgvPorts!=null)
            {
                foreach(var db in m_vArgvPorts)
                {
                    ...
                    if (connections != null)
                    {
                        List<DummyPort> vLinkPorts = new List<DummyPort>();
        ...
        public AgentTreeAttri GetAttri()
        {
            ...
            int customType = 0;
            if(bindNode is CutsceneAT.Runtime.CutsceneEvent)
            {
                customType = ((CutsceneAT.Runtime.CutsceneEvent)bindNode).eventType;
            }
        ...
        //------------------------------------------------------
        public void ChangeVariableType(ArvgPort port, CutsceneAT.Runtime.EVariableType newType)
        {
        ...
        protected virtual void DrawPortValue(ArvgPort port)
        {
            ...
            if (port.attri.argvType == typeof(CutsceneAT.Runtime.IVariable))
            {
                ...
                if(port.slotIndex>0)
                {
                    ...
                    if (port.isInput && m_vArgvPorts[0].attri.argvType == typeof(CutsceneAT.Runtime.IVariable))
                    {
                ...
                if(bDrawEnumPopVarType && port.isInput)
                {
                    ...
                    {
                        var popList = new List<CutsceneAT.Runtime.EVariableType>(port.attri.limitVarTypes);
                        if (!popList.Contains(port.eEnumType))
                            port.eEnumType = popList[0];
                        var popup = new PopupField<CutsceneAT.Runtime.EVariableType>(
                            popList,
                            port.eEnumType,
                            t => Framework.ED.EditorUtil.GetEnumDisplayName(t),
                            t => Framework.ED.EditorUtil.GetEnumDisplayName(t)
                        );
                    ...
                    else
                    {
                        ...
                        {
                            // 更新变量值
                            if ((CutsceneAT.Runtime.EVariableType)evt.newValue != CutsceneAT.Runtime.EVariableType.eNone)
                            {
                                port.eEnumType = (CutsceneAT.Runtime.EVariableType)evt.newValue;
                                OnArgvPortVarTypeChanged(port);
                                UpdateSize();
                            }
                        });
        ...
        protected virtual void InnerDrawPortValue(ArvgPort port, int insertIndex = -1)
        {
            ...
            if (portVariable is CutsceneAT.Runtime.VariableInt)
            {
                if (port.attri.argvType.IsEnum)
                {
                    var intVar = (CutsceneAT.Runtime.VariableInt)portVariable;
                    ...
                    varTypeField.SetEnabled(port.attri.canEdit);
                    {
                        ...
                        if (runtimeVar != null && runtimeVar is CutsceneAT.Runtime.VariableInt)
                            varTypeField.value = (Enum)Enum.ToObject(port.attri.argvType, ((CutsceneAT.Runtime.VariableInt)runtimeVar).value);
                    }
                ...
                else
                {
                    ...
                    if (!port.attri.canEdit)
                    {
                        var runtimeVar = m_pGraphView.GetRuntimeVariable(port);
                        if (runtimeVar != null && runtimeVar is CutsceneAT.Runtime.VariableInt)
                            intField.value =  ((CutsceneAT.Runtime.VariableInt)runtimeVar).value;
                    }
                    port.fieldRoot.Add(intField);
                    port.fieldElement = intField;
                }
            }
            if (portVariable is CutsceneAT.Runtime.VariableObjId)
            {
                var intVar = (CutsceneAT.Runtime.VariableObjId)portVariable;
                var intField = new IntegerField
                {
                ...
                {
                    var runtimeVar = m_pGraphView.GetRuntimeVariable(port);
                    if (runtimeVar != null && runtimeVar is CutsceneAT.Runtime.VariableObjId)
                        intField.value = ((CutsceneAT.Runtime.VariableObjId)runtimeVar).value.id;
                }
                port.fieldRoot.Add(intField);
                port.fieldElement = intField;
            }
            else if (portVariable is CutsceneAT.Runtime.VariableBool)
            {
                var intVar = (CutsceneAT.Runtime.VariableBool)portVariable;
                ...
                {
                    var runtimeVar = m_pGraphView.GetRuntimeVariable(port);
                    if (runtimeVar != null && runtimeVar is CutsceneAT.Runtime.VariableBool)
                        intField.value = ((CutsceneAT.Runtime.VariableBool)runtimeVar).value;
                }
                intField.RegisterValueChangedCallback(evt =>
                {
                    if (CanChangeValue(port))
            ...
            else if (portVariable is CutsceneAT.Runtime.VariableFloat)
            {
                var intVar = (CutsceneAT.Runtime.VariableFloat)portVariable;
                ...
                {
                    var runtimeVar = m_pGraphView.GetRuntimeVariable(port);
                    if (runtimeVar != null && runtimeVar is CutsceneAT.Runtime.VariableFloat)
                    {
                        intField.value = ((CutsceneAT.Runtime.VariableFloat)runtimeVar).value;  
                    }
                }
                port.fieldRoot.Add(intField);
                port.fieldElement = intField;
            }
            else if (portVariable is CutsceneAT.Runtime.VariableString)
            {
                var intVar = (CutsceneAT.Runtime.VariableString)portVariable;
                ...
                {
                    var runtimeVar = m_pGraphView.GetRuntimeVariable(port);
                    if (runtimeVar != null && runtimeVar is CutsceneAT.Runtime.VariableString)
                        intField.value = ((CutsceneAT.Runtime.VariableString)runtimeVar).value;
                }
                intField.RegisterValueChangedCallback(evt =>
                {
                    if(CanChangeValue(port))
            ...
            else if(portVariable is CutsceneAT.Runtime.VariableVec2)
            {
                var temVar = (CutsceneAT.Runtime.VariableVec2)portVariable;
                ...
                {
                    var runtimeVar = m_pGraphView.GetRuntimeVariable(port);
                    if (runtimeVar != null && runtimeVar is CutsceneAT.Runtime.VariableVec2)
                        intField.value = ((CutsceneAT.Runtime.VariableVec2)runtimeVar).value;
                }
                intField.RegisterValueChangedCallback(evt =>
                {
                    if (CanChangeValue(port))
            ...
            else if (portVariable is CutsceneAT.Runtime.VariableVec3)
            {
                var temVar = (CutsceneAT.Runtime.VariableVec3)portVariable;
                ...
                {
                    var runtimeVar = m_pGraphView.GetRuntimeVariable(port);
                    if (runtimeVar != null && runtimeVar is CutsceneAT.Runtime.VariableVec3)
                        intField.value = ((CutsceneAT.Runtime.VariableVec3)runtimeVar).value;
                }
                intField.RegisterValueChangedCallback(evt =>
                {
                    if (CanChangeValue(port))
            ...
            else if (portVariable is CutsceneAT.Runtime.VariableVec4)
            {
                var temVar = (CutsceneAT.Runtime.VariableVec4)portVariable;
                ...
                {
                    var runtimeVar = m_pGraphView.GetRuntimeVariable(port);
                    if (runtimeVar != null && runtimeVar is CutsceneAT.Runtime.VariableVec4)
                        intField.value = ((CutsceneAT.Runtime.VariableVec4)runtimeVar).value;
                }
                intField.RegisterValueChangedCallback(evt =>
                {
                    if (CanChangeValue(port))
                ...
                if (port.attri.argvType.IsEnum)
                {
                    if (port.fieldElement is EnumField)
                    {
                        ...
                        if (runtimeVar != null && runtimeVar is CutsceneAT.Runtime.VariableInt)
                        {
                            ...
                            enumField.value = (Enum)Enum.ToObject(port.attri.argvType, ((CutsceneAT.Runtime.VariableInt)runtimeVar).value);
                        }
                    }
                }
                else
                {
                    if (port.fieldElement is IntegerField)
                    {
                        ...
                        if (runtimeVar != null && runtimeVar is CutsceneAT.Runtime.VariableInt)
                        {
                            ...
                            eleField.value = ((CutsceneAT.Runtime.VariableInt)runtimeVar).value;
                        }
                    }
                }
            }
            else if (portVariable is CutsceneAT.Runtime.VariableObjId)
            {
                if (port.fieldElement is IntegerField)
                {
                    var runtimeVar = m_pGraphView.GetRuntimeVariable(port);
                    ...
                    {
                        IntegerField eleField = (IntegerField)port.fieldElement;
                        eleField.value = ((CutsceneAT.Runtime.VariableObjId)runtimeVar).value.id;
                    }
                }
            }
            else if (portVariable is CutsceneAT.Runtime.VariableBool)
            {
                if (port.fieldElement is Toggle)
                {
                    ...
                    if (runtimeVar != null && runtimeVar is CutsceneAT.Runtime.VariableBool)
                    {
                        ...
                        eleField.value = ((CutsceneAT.Runtime.VariableBool)runtimeVar).value;
                    }
                }
            }
            else if (portVariable is CutsceneAT.Runtime.VariableFloat)
            {
                if (port.fieldElement is FloatField)
                {
                    ...
                    if (runtimeVar != null && runtimeVar is CutsceneAT.Runtime.VariableFloat)
                    {
                        ...
                        eleField.value = ((CutsceneAT.Runtime.VariableFloat)runtimeVar).value;
                    }
                }
            }
            else if (portVariable is CutsceneAT.Runtime.VariableString)
            {
                if (port.fieldElement is TextField)
                {
                    ...
                    if (runtimeVar != null && runtimeVar is CutsceneAT.Runtime.VariableString)
                    {
                        ...
                        eleField.value = ((CutsceneAT.Runtime.VariableString)runtimeVar).value;
                    }
                }
            }
            else if (portVariable is CutsceneAT.Runtime.VariableVec2)
            {
                if (port.fieldElement is Vector2Field)
                {
                    ...
                    if (runtimeVar != null && runtimeVar is CutsceneAT.Runtime.VariableVec2)
                    {
                        ...
                        eleField.value = ((CutsceneAT.Runtime.VariableVec2)runtimeVar).value;
                    }
                }
            }
            else if (portVariable is CutsceneAT.Runtime.VariableVec3)
            {
                if (port.fieldElement is Vector3Field)
                {
                    ...
                    if (runtimeVar != null && runtimeVar is CutsceneAT.Runtime.VariableVec3)
                    {
                        ...
                        eleField.value = ((CutsceneAT.Runtime.VariableVec3)runtimeVar).value;
                    }
                }
            }
            else if (portVariable is CutsceneAT.Runtime.VariableVec4)
            {
                if (port.fieldElement is Vector4Field)
                {
                    ...
                    if (runtimeVar != null && runtimeVar is CutsceneAT.Runtime.VariableVec4)
                    {
                        ...
                        eleField.value = ((CutsceneAT.Runtime.VariableVec4)runtimeVar).value;
                    }
                }
            }
        }
