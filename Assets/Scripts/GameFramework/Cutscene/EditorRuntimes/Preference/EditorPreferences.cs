...
namespace Framework.Cutscene.Editor
{
    public class EditorPreferences
    {
        ...
        public class Settings : ISerializationCallbackReceiver
        {
            ...
            public string generatorCodePath = "Assets/Scripts/GameMain/Generators/Cutscene";
            ...
            public Texture2D gridTexture
            {
                get
                {
                    if (_gridTexture == null) _gridTexture = Framework.ED.UIDrawUtils.GenerateGridTexture(gridLineColor, gridBgColor);
                    return _gridTexture;
                }
            }
            ...
            public Texture2D crossTexture
            {
                get
                {
                    if (_crossTexture == null) _crossTexture = Framework.ED.UIDrawUtils.GenerateCrossTexture(gridLineColor);
...
//#if UNITY_2019_1_OR_NEWER
        ...
        public static SettingsProvider CreateActorSystemSettingsProvider() {
            SettingsProvider provider = new SettingsProvider("Preferences/GameFramework/CutsceneEditor", SettingsScope.User) {
