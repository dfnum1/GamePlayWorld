...
namespace Framework.Core
{
    ...
    public static class KCPUtil
    {
        ...
        [DllImport(KcpDLL, CallingConvention = CallingConvention.Cdecl)]
        private static extern void ikcp_setlog(IntPtr kcp, KcpLog log);
        ...
        public static void KcpSetLog(IntPtr kcp, KcpLog kcpLog)
        {
            KcpLog = kcpLog;
            ikcp_setlog(kcp,KcpLog);
        }
