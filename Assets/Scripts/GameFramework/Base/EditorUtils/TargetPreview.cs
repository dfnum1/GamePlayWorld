...
namespace Framework.ED
{
    ...
    public class TargetPreview : ObjectPreview
    {
        ...
        private void InitPreview()
        {
            ...
            m_FloorTexture = (Texture2D)EditorGUIUtility.Load("editor_preview_ground.png");
        ...
        {
            m_PreviewUtility.lights[0].intensity = 2.0f;
            m_PreviewUtility.lights[0].transform.rotation = Quaternion.Euler(40f, 40f, 0f);
            m_PreviewUtility.lights[1].intensity = 2.0f;

            Color ambient = new Color(1f, 1f, 1f, 1f);
