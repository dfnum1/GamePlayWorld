...
public class UnitySVN
{
    ...
    private const string SVN_REVERT = "Assets/SVN/Revert";
    ...
    public static void SVNAdd(string[] paths)
    {
    ...
    public static void SVNCommit(params string[] paths)
    {
        if (paths == null || paths.Length <= 0) return;
        string path = string.Empty;
    ...
    {
        SVNCommand(REVERT, GetSelectedObjectPath());
    }
