...
namespace Framework.ED
{
    ...
    public static class InspectorDrawUtil
    {
        ...
        struct PluginInspector
        {
            ...
            public PluginInspectorAttribute attr;
        }
        //-----------------------------------------------------
        ...
        public static void CheckInspector()
        {
            ...
            foreach (var assembly in System.AppDomain.CurrentDomain.GetAssemblies())
            {
                ...
                {
                    Type tp = types[i];
                    if (tp.IsDefined(typeof(PluginInspectorAttribute), false))
                    {
                        PluginInspectorAttribute pAttr = tp.GetCustomAttribute<PluginInspectorAttribute>();
                    ...
                    if (tp.IsDefined(typeof(StringViewPluginAttribute), false))
                    {
                        StringViewPluginAttribute pAttr = tp.GetCustomAttribute<StringViewPluginAttribute>();
        ...
        //------------------------------------------------------
        public static int DrawBitView(GUIContent strDispalyName, int nValue, BitViewGUIAttribute[] bitAttrs)
        {
            ...
            System.Object parentData = null, System.Reflection.FieldInfo parentFieldInfo = null)
        {
            ...
            //{
            //    var pathFiled = finfos[i].GetCustomAttribute<ObjPathFieldAttribute>(false);
            //    if (pathFiled == null) continue;
            //    if (string.IsNullOrEmpty(pathFiled.fieldName)) continue;
            //    ms_vFilterFields.Add(pathFiled.fieldName);
            //}
            ...
            if (methods != null)
            {
                ...
                {
                    if (methods[i].IsDefined(typeof(AddInspectorAttribute), false))
                    {
        ...
        public static System.Object DrawPropertyField(System.Object data, FieldInfo finfo, System.Action<string> OnSubDraw = null, string displayName = null, OnFieldDirtyDelegate OnChangeField = null, System.Object pParentData = null, System.Reflection.FieldInfo parentFieldInfo = null)
        {
            ...
            {
                if(parentFieldInfo.IsDefined(typeof(DisableFiledGUIAttribute)))
                {
                    var attr = parentFieldInfo.GetCustomAttribute<DisableFiledGUIAttribute>();
                    if(attr!=null && attr.fields!=null)
                    {
                        for(int i=0;i< attr.fields.Length;++i)
                        {
                            if(attr.fields[i].Equals(finfo.Name, StringComparison.OrdinalIgnoreCase))
                            {
            ...
            using (new FieldScope(data, finfo, !isUnEdit, OnChangeField))
            {
                ...
                if (finfo.IsDefined(typeof(DisableGUIAttribute)))
                {
                    if (OnSubDraw != null) OnSubDraw(finfo.Name);
                    return data;
                }
                ...
                EditFloatAttribute editFloatAttr = null;
                if (finfo.IsDefined(typeof(EditFloatAttribute)))
                {
                    editFloatAttr = finfo.GetCustomAttribute<EditFloatAttribute>();
                }

                if (finfo.IsDefined(typeof(StateGUIByFieldAttribute)))
                {
                    StateGUIByFieldAttribute[] attrs = (StateGUIByFieldAttribute[])finfo.GetCustomAttributes<StateGUIByFieldAttribute>();
                    bool bHasDraw = false;
                ...
                if (finfo.IsDefined(typeof(StateGUIByTypeAttribute)))
                {
                    StateGUIByTypeAttribute typeSets = finfo.GetCustomAttribute<StateGUIByTypeAttribute>();
                ...
                if (finfo.IsDefined(typeof(StateGUIByBitAttribute)))
                {
                    StateGUIByBitAttribute[] attrs = (StateGUIByBitAttribute[])finfo.GetCustomAttributes<StateGUIByBitAttribute>();
                    for (int i = 0; i < attrs.Length; ++i)
                    {
                        FieldInfo byField = data.GetType().GetField(attrs[i].fieldName, BindingFlags.Public | BindingFlags.Instance);
                        if (byField != null)
                ...
                {
					var displayAttr = finfo.GetCustomAttribute<DisplayAttribute>();
                ...
                if (finfo.IsDefined(typeof(DisplayNameByFieldAttribute)))
                {
                    DisplayNameByFieldAttribute[] attr = (DisplayNameByFieldAttribute[])finfo.GetCustomAttributes<DisplayNameByFieldAttribute>();
                ...
                if (finfo.IsDefined(typeof(DisplayRenderLayerByFieldAttribute)))
                {
                    DisplayRenderLayerByFieldAttribute[] typeSets = (DisplayRenderLayerByFieldAttribute[])finfo.GetCustomAttributes<DisplayRenderLayerByFieldAttribute>();
                ...
                bool bBit = false;
                if (finfo.IsDefined(typeof(DisplayEnumBitGUIAttribute)))
                {
                    DisplayEnumBitGUIAttribute attr = finfo.GetCustomAttribute<DisplayEnumBitGUIAttribute>();
                    byType = attr.GetEnumType();
                    bEnumBitOffset = attr.bBitOffset;
                    bBit = true;
                }
                if (finfo.IsDefined(typeof(DisplayTypeByFieldAttribute)))
                {
                    DisplayTypeByFieldAttribute[] typeSets = (DisplayTypeByFieldAttribute[])finfo.GetCustomAttributes<DisplayTypeByFieldAttribute>();
                    for (int i = 0; i < typeSets.Length; ++i)
                    {
                        FieldInfo byField = data.GetType().GetField(typeSets[i].fieldName, BindingFlags.Public | BindingFlags.Instance);
                        if (byField != null)
                ...
                if (bBit && byType != null && byType.IsEnum)
                {
                    ...
                    int.TryParse(finfo.GetValue(data).ToString(), out flag);
                    {
                        ...
                        foreach (Enum v in Enum.GetValues(byType))
                        {
                            ...
                            if (fi.IsDefined(typeof(DisableGUIAttribute)))
                            {
                                continue;
                            }
                            ...
                            {
                				var dispAttr = fi.GetCustomAttribute<DisplayAttribute>();

                                strName = dispAttr.displayName;
                                tips = dispAttr.strTips;                            }
                            if (fi.IsDefined(typeof(StateGUIByTypeAttribute)))
                            {
                                StateGUIByTypeAttribute typeSets = fi.GetCustomAttribute<StateGUIByTypeAttribute>();
                                if (!typeSets.typeSets.Contains(data.GetType()))
                                {
                                    continue;
                                }
                ...
                if (finfo.IsDefined(typeof(Data.FormSelectFieldAttribute)))
                {
                    Data.FormSelectFieldAttribute attri = finfo.GetCustomAttribute<Data.FormSelectFieldAttribute>();
                    if (!string.IsNullOrEmpty(attri.fieldName))
                    {
                        ...
                        if (byField != null)
                        {
                            ...
                            Data.FormViewBinderAttribute[] form_attri = (Data.FormViewBinderAttribute[])finfo.GetCustomAttributes<Data.FormViewBinderAttribute>();
                ...
                else if (finfo.IsDefined(typeof(Data.FormViewBinderAttribute)))
                {
                    Data.FormViewBinderAttribute[] attri = (Data.FormViewBinderAttribute[])finfo.GetCustomAttributes<Data.FormViewBinderAttribute>();
                    if (attri.Length > 0)
                    {
                ...
                if(tableType!=null)
                {
                    if (finfo.IsDefined(typeof(Data.FormFieldDisplayAttribute)))
                    {
                        Data.FormFieldDisplayAttribute attri = finfo.GetCustomAttribute<Data.FormFieldDisplayAttribute>();
                        if (!string.IsNullOrEmpty(attri.fieldName))
                        {
                            Data.Data_Base pTable = Data.ED.DataEditorUtil.GetTable<Data.Data_Base>(tableType);
                            if(pTable!=null)
                            {
                                System.Type dataType = DataEditorUtil.GetTableDataType(tableType);
                                if(dataType!=null)
                                {
                                    string strSelectValue = DataEditorUtil.GetTableDataAttrFieldDisplayName(pTable, strField, finfo.GetValue(data).ToString(), attri.fieldName);
                                    if (strSelectValue != null)
                                    {
                                        strDisplayName = strSelectValue;
                                    }
                                }
                ...
                if (finfo.IsDefined(typeof(DisplayEnumGUIAttribute)))
                {
                    bOnlyDisplayEnumGUI = true;
                    DisplayEnumGUIAttribute attr = finfo.GetCustomAttribute<DisplayEnumGUIAttribute>();
                ...
                if (finfo.IsDefined(typeof(DisplayDrawTypeAttribute)))
                {
                    DisplayDrawTypeAttribute typeSets = finfo.GetCustomAttribute<DisplayDrawTypeAttribute>();
                ...
                RowFieldInspectorAttribute drawLineRow = null;
                if (finfo.IsDefined(typeof(RowFieldInspectorAttribute)))
                {
                    drawLineRow = finfo.GetCustomAttribute<RowFieldInspectorAttribute>();
                }

                if (tableType != null || (byType != null && byType.IsEnum) || finfo.IsDefined(typeof(DefaultValueAttribute)) || OnSubDraw != null || drawLineRow!=null)
                    bHorizontal = true;

                if (finfo.IsDefined(typeof(DisplayDrawTypeAttribute)))
                    bHorizontal = false;

                if (byType != null && byType.IsEnum)
                    bOnlyDisplayEnumGUI = true;
                ...
                ObjPathFieldAttribute pathFiledAttr = finfo.GetCustomAttribute<ObjPathFieldAttribute>();
                ...
                BitViewGUIAttribute[] bitViewAttrs = (BitViewGUIAttribute[])finfo.GetCustomAttributes<BitViewGUIAttribute>();
                ...
                //     if(!bOnlyDisplayEnumGUI)
                {
                    if (finfo.FieldType == typeof(string))
                    {
                        ...
                        if (finfo.IsDefined(typeof(BindSlotGUIAttribute)) || (byType != null && byType == typeof(BindSlotGUIAttribute)))
                        {
                        ...
                        else if (finfo.IsDefined(typeof(StringViewPluginAttribute)))
                        {
                            StringViewPluginAttribute attri = (StringViewPluginAttribute)finfo.GetCustomAttribute<StringViewPluginAttribute>();
                            if (!DrawStringUserPlugin(data, finfo, displayNameContent, ref strValue, attri.userPlugin))
                            {
                                strValue = EditorGUILayout.TextField(strDisplayName, strValue);
                            }
                            finfo.SetValue(data, strValue);
                        }
                        else if (finfo.IsDefined(typeof(StateStringViewGUIAttribute)))
                        {
                            StateStringViewGUIAttribute[] attri = (StateStringViewGUIAttribute[])finfo.GetCustomAttributes<StateStringViewGUIAttribute>();
                            ...
                            if (bindType != null)
                            {
                                ...
                                {
                                    strPath = EditorFilePath.DrawPathObject(displayNameContent, strPath, bindType, false);
                                }
                            }
                            else
                            {
                        ...
                        else if (finfo.IsDefined(typeof(StringViewGUIAttribute)))
                        {
                            StringViewGUIAttribute[] attris = (StringViewGUIAttribute[])finfo.GetCustomAttributes<StringViewGUIAttribute>();
                            ...
                            {
                                StringViewGUIAttribute attri = ms_TempOrderAttrs[x].attr as StringViewGUIAttribute;
                                if (attri.GetBindType() != null)
                                {
                                    if (!DrawStringUserPlugin(data, finfo, displayNameContent, ref strValue, attri.GetBindType()))
                                    {
                                        string strPath = strValue;
                                        strPath = EditorFilePath.DrawPathObject(displayNameContent, strPath, attri.GetBindType(), false);
                                        finfo.SetValue(data, strPath);
                                    }
                                    else
                                    {
                        ...
                        else if (finfo.IsDefined(typeof(SelectFileGUIAttribute)))
                        {
                            ...
                            {
                                SelectFileGUIAttribute attri = finfo.GetCustomAttribute<SelectFileGUIAttribute>();
                        ...
                        else if (finfo.IsDefined(typeof(SelectDirGUIAttribute)))
                        {
                            GUILayout.BeginHorizontal();
                            string strPath = strValue;
                            strPath = EditorGUILayout.TextField(displayNameContent, strPath);
                            if (GUILayout.Button("...", new GUILayoutOption[] { GUILayout.Width(30) }))
                            {
                                SelectDirGUIAttribute attri = finfo.GetCustomAttribute<SelectDirGUIAttribute>();
                                string strRoot = attri.root;
                                if (string.IsNullOrEmpty(attri.root))
                                    strRoot = Application.dataPath;
                                else
                    ...
                    else if (finfo.FieldType == typeof(int))
                    {
                        ...
                        else if (byType != null && byType == typeof(Cutscene.Runtime.BinderUnityObject))
                        {
                            finfo.SetValue(data, ((int)(Cutscene.Runtime.ObjectBinderUtils.DrawBinderInspector((int)finfo.GetValue(data), displayName))));
                        }
                        else if (dislayRenderLayer)
                        {
                            finfo.SetValue(data, LayerUtil.PopRenderLayer(displayNameContent, (int)finfo.GetValue(data)));
                        }
                    ...
                    else if (finfo.FieldType == typeof(uint))
                    {
                        ...
                        {
                            finfo.SetValue(data, (uint)LayerUtil.PopRenderLayer(displayNameContent, (int)(uint)finfo.GetValue(data)));
                        }
                        else if (bitViewAttrs != null && bitViewAttrs.Length > 0)
                        {
                    ...
                    else if (finfo.FieldType == typeof(Texture2D))
                    {
                        ...
                        if (objFilePathField != null)
                            objFilePathField.SetValue(data, EditorFilePath.GetObjectAdjustPath(obj));
                    }
                    ...
                    {
                        GUILayout.BeginHorizontal();
                        Framework.Plugin.AT.AAgentTreeData pAT = (Framework.Plugin.AT.AAgentTreeData)EditorGUILayout.ObjectField(strDisplayName, (Framework.Plugin.AT.AAgentTreeData)finfo.GetValue(data), finfo.FieldType, true);
                    ...
                    else if (finfo.FieldType == typeof(Framework.Plugin.AT.AgentTreeCoreData))
                    {
                        ...
                        atData.bEnable = EditorGUILayout.Toggle("启用AT", atData.bEnable);
                    ...
                    else if (IsScriptObject(finfo.FieldType))
                    {
                        ...
                        finfo.SetValue(data, obj);
                        if (objFilePathField != null)
                            objFilePathField.SetValue(data, obj ? EditorFilePath.GetObjectAdjustPath(obj) : "");
                    }
                    else if (IsUnityObject(finfo.FieldType))
                    {
                        ...
                        if (objFilePathField != null)
                            objFilePathField.SetValue(data, objVal ? EditorFilePath.GetObjectAdjustPath(objVal) : "");
                    }
                    else
                    {
                        if (finfo.IsDefined(typeof(DisplayAttribute)))
                ...
                if (finfo.IsDefined(typeof(DefaultValueAttribute)))
                {
                    DefaultValueAttribute def = finfo.GetCustomAttribute<DefaultValueAttribute>();
        ...
        {
            bool bNoHeader = field.IsDefined(typeof(NoListHeaderGUIAttribute));
            int curLent = 0;
