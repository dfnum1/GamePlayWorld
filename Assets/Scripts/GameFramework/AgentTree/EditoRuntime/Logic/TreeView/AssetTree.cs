...
namespace Framework.Plugin.AT
{
	public class AssetTree 
	{
        ...
        public void AddUser(string guid, string name, bool forceExpand = false)
        {
            if (string.IsNullOrEmpty(guid)) return;
            ...
            while (startIndex < length)
            {
                ...
                AssetData pathNode = new AssetData(endIndex == -1 ? guid : null, directory, assetPath.Substring(0, endIndex == -1 ? length : endIndex), forceExpand || node.Level == 0);
