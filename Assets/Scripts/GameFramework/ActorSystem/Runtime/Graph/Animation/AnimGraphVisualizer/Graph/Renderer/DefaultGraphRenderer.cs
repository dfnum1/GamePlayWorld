...
namespace Framework.GraphVisualizer
{
    public class DefaultGraphRenderer : IGraphRenderer
    {
        ...
        private void InitializeStyles()
        {
            ...
            GUIStyleState rectNoraml = new GUIStyleState();
            rectNoraml.background = EditorGUIUtility.Load("GraphNode.png") as Texture2D;
            rectNoraml.textColor = Color.black;
            m_NodeRectStyle.normal = rectNoraml;

            m_NodeRectStyle.border = new RectOffset(10, 10, 10, 10);
            m_NodeRectStyle.alignment = TextAnchor.MiddleCenter;
            m_NodeRectStyle.wordWrap = true;
            m_NodeRectStyle.clipping = TextClipping.Clip;
