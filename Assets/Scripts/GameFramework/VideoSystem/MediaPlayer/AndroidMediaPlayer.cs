    ...
    public class AndroidMediaPlayer : MonoBehaviour, IMediaPlayer
    {
        ...
        static void InitialisePlatform()
        {
			...
			if( !s_bInitialised )
			{
				...
				AndroidJavaObject videoClass = new AndroidJavaObject("com.unity3d.video.MoblieVideo");
				if( videoClass != null )
				{
        ...
        //-------------------------------------------------
        public bool OpenVideoFromFile(string path, bool bAutoPlay=true, bool bPersistentRoot = false, long offset = 0, string httpHeaderJson = null)
		{
			bool bReturn = false;
