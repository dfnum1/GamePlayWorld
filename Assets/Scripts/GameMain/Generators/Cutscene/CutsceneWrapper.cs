		...
		public static Framework.Cutscene.Runtime.IDataer CreateDataer(Framework.Cutscene.Runtime.EDataType type, ushort typeId)
		{
		    switch(type)
		    {
		        case Framework.Cutscene.Runtime.EDataType.eClip:
		            switch(typeId)
		            {
		                case 21: return new GameApp.Cutscene.CutsceneAudioClip();
		                case 22: return new GameApp.Cutscene.CutsceneVideoClip();
		                case 501: return new Framework.Cutscene.Runtime.HitFrameClip();
		                case 500: return new Framework.Cutscene.Runtime.MoveToTargetClip();
		                ...
		                case 20: return new Framework.Cutscene.Runtime.ProjectileClip();
